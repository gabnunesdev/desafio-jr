...
export function PetCard({ pet, isSelected, onSelect }: PetCardProps) {
    ...
    // Hover state style is handled by CSS group-hover or hover classes on the wrapper.
    // Selected state style adds specific border and glow.
                    ...
                    <div className="overflow-hidden space-y-3">
                        ...
                        <div className="space-y-2">
                             ...
                             <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium">Telefone:</span> {pet.phone || "Não informado"}
                             </div>
                             <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col gap-2 mt-4 pt-2">
                            <Button className="w-full bg-white text-blue-600 hover:bg-slate-100 font-semibold h-10 rounded-lg">
